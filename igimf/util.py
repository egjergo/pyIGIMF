...
def Kroupa01(Mstar, alpha0=0.3, alpha1=1.3, alpha2=2.3, alpha3=2.3,
    ...
    return np.piecewise(Mstar, 
            ...
            [0., 
                lambda M: 1/(lim01*lim12) * powerlaw(M, alpha=alpha0),
                lambda M: 1/lim12 * powerlaw(M, alpha=alpha1), 
                lambda M: powerlaw(M, alpha=alpha2), 
                lambda M: powerlaw(M, alpha=alpha3)])
